...
Weave is the founding asset of the [Libre Commons](https://github.com/The-Libre-Project/Commons), a public infrastructure stewardship framework that draws a hard boundary between commons-scope work and product work. The Commons operates a [Standards Register](https://github.com/The-Libre-Project/Commons/tree/main/standards) that publishes open standards and defensive publications — timestamped prior art, open specifications, and public-domain dedications — to keep the useful conventions of free computing in the public domain and out of patent capture.
...
Weave is built and maintained by [IronTree Software](https://github.com/The-Libre-Project), as the founding asset of the [Libre Commons](https://github.com/The-Libre-Project/Commons). For security disclosures, see [SECURITY.md](SECURITY.md).
